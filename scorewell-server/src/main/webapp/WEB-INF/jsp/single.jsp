		...
		<div class="container">
			...
			<div class="news-single">
			     <div class="news-grid-single">
				   ...
				   <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam,Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam,Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore eaque ipsa quae ab illo inventore eaque ipsa quae ab illo inventore...</p>
				   <div class="bog_post_info infoPost">
					   <span class="datePost"><a href="#" class="post_date">sep 10, 2015</a></span>
